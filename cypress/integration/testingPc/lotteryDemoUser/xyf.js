...
describe('幸运农场投注页面投注验证', () => {
  ...
  context('点击首页试玩按钮，[可]试玩登入且进入幸运农场投注页', () => {
    before(() => {
