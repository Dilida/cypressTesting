...
describe('秒速11选5投注页面投注验证', () => {
  ...
  context('点击首页试玩按钮，[可]试玩登入且进入秒速11选5投注页', () => {
    ...
    it('秒速11选5投注，[可]看见任选投注应成功且顯示投注紀錄', () => {
      cy.clickTab(3,3);
      cy.isNeedtoBet()
        .fixture('betOrder').then((json)=>{
          if(json.couldBet){
