...
describe('台湾5分彩投注页面投注验证', () => {
  ...
  context('点击首页试玩按钮，[可]试玩登入且进入台湾5分彩投注页', () => {
    ...
    it('台湾5分彩投注页header显示，[可]看见投注彩种名及logo/显示注当期期号/上一期期號及開獎結果', () => {
      cy.lotteryHeaderFunc(lotteryHeader);
    })

    it('台湾5分彩点击玩法说明，[可]看见弹出视窗显示台湾5分彩玩法说明', () => {
